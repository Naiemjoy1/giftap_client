...
const EventCalendar = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center p-4 space-y-4 lg:space-y-0 lg:space-x-4">
      {/* Calendar Section */}
          ...
          {selectedDayEvents.length > 0 ? (
            <div className="p-4 bg-green-100 text-green-800 rounded-md">
              ...
              <p>
                ...
                <span className="font-bold">{selectedDayEvents[0].name}</span>.
                Enjoy your day!
              </p>
            </div>
          ) : (
