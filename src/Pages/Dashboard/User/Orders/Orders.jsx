...
const Orders = () => {
  ...
  const myOrders = payments.filter(
    (item) => item?.cus_email === user?.email && item?.status === "success"
  );
                  ...
                  {relatedProducts.map((product, productIndex) => {
                    ...
                    return (
                      <tr key={`product-${productIndex}`}>
                        ...
                        <td className="border border-gray-300">
                          {productInfo?.delivery === "home"
                            ? "Pending"
                            : productInfo?.delivery || "No delivery info"}
                        </td>
