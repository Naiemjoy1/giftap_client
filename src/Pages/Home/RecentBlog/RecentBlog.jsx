...
const RecentBlog = () => {
  ...
  return (
    <>
      ...
      <div className="container 2xl:w-[70%] mx-auto space-y-4 px-4">
        {/* Featured Blog */}
        <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {blog.slice(19, 22).map((item) => (
            <Link
              ...
              key={item._id}
              className="group hover:no-underline focus:no-underline bg-white dark:bg-gray-50 shadow-md rounded-lg overflow-hidden transition-transform transform hover:scale-105 duration-300"
            >
              <img
                role="presentation"
