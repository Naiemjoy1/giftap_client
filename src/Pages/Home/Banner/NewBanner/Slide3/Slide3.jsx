...
import img1 from "../../../../../assets/Images/Banner/fashon3.png";
import img2 from "../../../../../assets/Images/Banner/fashon1.png";
import img3 from "../../../../../assets/Images/Banner/fashon2.png";
      ...
      <div className="lg:w-[60%] md:w-1/2 lg:space-y-8 space-y-4">
        <div className="lg:w-4/5 space-y-4">
          <p className="text-4xl lg:text-6xl font-medium font-poppins">
            Fashion & Accessories for Your Every Style
          </p>
        ...
        <div className="flex gap-4 items-center">
          <div className="flex items-center gap-2 bg-white rounded-badge py-2 px-2 w-1/2">
            ...
            <div className="space-y-0 lg:space-y-2">
              <p className="font-semibold">Aromatherapy Kit</p>
          ...
          <div className="flex items-center gap-2 bg-white rounded-badge py-2 px-2 w-1/2">
            ...
            <div className="space-y-0 lg:space-y-2">
              <p className="font-semibold">Skincare and Bath</p>
