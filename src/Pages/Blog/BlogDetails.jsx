  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosPublic.post(
        `/blogs/${blogDetails._id}/comments`,
        newComment
      );
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-4">
        ...
        <div className="w-full lg:w-3/4 lg:p-4">
          <div>
            ...
            <img
              src={blogImage}
              alt="GifTap has No Photo"
              className="w-full rounded-lg"
            />
            <p className="text-lg lg:text-xl font-semibold text-gray-500 mt-8">
              {blogDescription}
            </p>
              ...
              {user ? (
                <div className="flex flex-col lg:flex-row">
                  <textarea
                    ...
                    className="textarea textarea-bordered border-blue-400 textarea-sm lg:textarea-md w-full lg:max-w-xs mb-2 lg:mb-0"
                  ></textarea>
                  <button
                    className="btn btn-primary text-sm lg:text-xl font-bold text-black mt-2 lg:mt-0 lg:ml-2"
                    type="submit"
                  >
                    Submit
                  </button>
                ...
                <div className="flex flex-col lg:flex-row">
                  ...
                  ></textarea>
                  <Link to="/login">
                    <button className="btn btn-primary text-sm lg:text-xl font-bold text-black mt-2 lg:mt-0 lg:ml-2">
                      Login
                    </button>
                  </Link>
                </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <div className="bg-gray-300 rounded-2xl p-2">
                        <h1 className="text-[16px] lg:text-[18px] font-bold text-black">
                          {comment.commentName}
                        </h1>
                ...
                <div className="modal-box">
                  <div className="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:justify-center sm:-mx-2">
                    <input
                      type="text"
                      id="text"
                      className="px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
                      placeholder="Type Your Comment..."
                    />
                    <button className="px-4 py-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-primary rounded-md sm:mx-2">
                      Submit
                    </button>
                  </div>
                </div>
              ...
              <dialog id="my_modal_3" className="modal">
                <div className="modal-box h-32">
                  <div className="flex items-center">
                    <input
                      type="text"
                      placeholder={`${window.location.origin}/BlogDetails/${blogDetails._id}`}
                      className="block w-full rounded-tl-lg rounded-bl-lg placeholder-gray-400/70 dark:placeholder-gray-500 border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300"
                    />
                    <p
                      className="py-2.5 px-3 rounded-tr-lg rounded-br-lg text-gray-500 bg-gray-100 dark:bg-gray-800 dark:border-gray-700 cursor-pointer"
                  ...
                  <form method="">
                    <button className="btn btn-sm btn-primary absolute mb-6 mt-4">
                      Close
                    </button>
                  </form>
                </div>
