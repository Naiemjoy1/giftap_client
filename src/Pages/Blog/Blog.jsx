      ...
      <div className="   ">
        ...
        <div className='ml-[580px]  mb-7'>
          <label className="input input-bordered flex items-center gap-2 lg:mt-4 w-96">
            <input type="text" className="grow" placeholder="Search Blog Title ..." />
              ...
              <div key={blog.id} className="">
                ...
                <div className='relative overflow-hidden group '>
                  <Link to={`/BlogDetails/${blog._id}`}>
                    {/* Image */}
                    <img src={blog.blogImage} alt={blog.title} className="w-full h-80 object-cover mb-2 transition-transform duration-700 ease-in-out group-hover:scale-105 rounded-lg " />
